    ...
    return (
      <div className="flex justify-center items-center h-64">
        <div className="text-center">
          ...
          <p style={{ color: '#6D6157' }}>Loading blog data...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="w-full">
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center space-x-4">
          ...
          <h1 className="text-3xl font-bold" style={{ color: '#2F2F2F' }}>Edit Blog</h1>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm p-3 rounded-lg" style={{ color: '#6D6157', backgroundColor: '#FAF8F3' }}>
              The content can include HTML and will render on the blog post page using dangerouslySetInnerHTML.
            </p>
            <textarea
              required
              rows={12}
